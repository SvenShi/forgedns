...
use super::{
    build_address_response_packet, build_response_packet, response_answer_any_ip,
    response_answer_ip_ttls, response_answer_ips, response_cnames, response_has_answer_type,
    response_ips, response_rcode, rewrite_response_ttls,
};
...
#[test]
/// Verify synthetic reject packets preserve the request ID, opcode, and question section.

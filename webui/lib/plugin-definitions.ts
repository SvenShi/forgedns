...
const inputArrayItem = (placeholder: string): ConfigFieldChild => ({
  optionKey: "input",
  type: "text",
  label: "输入值",
  placeholder,
});
const providerReferenceArrayItem = (placeholder: string): ConfigFieldChild => ({
...
const executorReferenceArrayItem = (placeholder: string): ConfigFieldChild => ({
...
const nftSetTargetFields: ConfigField[] = [
  {
    key: "table_family",
    label: "表 Family",
    type: "text",
    ...
    configSchema: [
      stringArrayField(
        ...
        [
          ...
          inputArrayItem("domain:example.com"),
        ],
      ),
    ],
  },
